...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <h3 class="text-dark mb-4">Send Order Customer Mail </h3>
                ...
                <div class="col-lg-8"> <!-- Adjusted column width for better form layout -->
                    <div class="card shadow mt-n6">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Send Order Customer Mail</p>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" id="mailform">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="recipient" id="recipient" class="form-control">
                                        ...
                                        <option value="ordercustomers">All Order Customers</option>
                                        </select>
                                </div>
                                <div class="form-group">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function createOption(customer) {
                ...
                newOption.textContent = `Order Customer-${customer.firstname} ${customer.lastname}`.toUpperCase();
