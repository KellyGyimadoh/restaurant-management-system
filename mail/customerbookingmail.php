...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <h3 class="text-dark mb-4">Send Booking Customer Mail </h3>
            <div class="row justify-content-center min-vh-100 align-items-center mt-n7">
                <div class="col-lg-8"> <!-- Adjusted column width for better form layout -->
                    <div class="card shadow mt-n6">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Send Booking Customer Mail</p>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" id="mailform">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="recipient" id="recipient" class="form-control">
                                        ...
                                        <option value="bookingcustomers">All Booking Customers</option>
                                    </select>
                                </div>
                                <div class="form-group">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const customerSelect = document.getElementById("recipient");

            async function retrieveCustomers() {
                try {
                    const response = await fetch("../api/customers/process.retrievebookingcustomers.php");
                    if (!response.ok) {
                    ...
                    if (data.success) {
                       ...
                       // customerSelect.innerHTML = '<option value="">Select Name</option>';
            ...
            function createOption(customer) {
                ...
                newOption.value = customer.email;
                newOption.textContent = `${customer.name}`.toUpperCase();
