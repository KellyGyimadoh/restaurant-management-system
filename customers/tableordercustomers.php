...
if (isset($_SESSION['updatedordercustomer']) && $_SESSION['updatedordercustomer'] == true) {
    echo "<script>alert('User Successfully updated')</script>";
    unset($_SESSION['updatedordercustomer']);
}
...
$selectorderCustomers = new Selectordercustomer($limit, $offset, $search);

$total_users = $selectorderCustomers->totalCustomerCount();
$total_pages = ceil($total_users / $limit);
$result = $selectorderCustomers->selectTableWithLimit();
                            ...
                            <tbody>
                                ...
                                if (!empty($result)) {
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        $date = htmlspecialchars($row['regdate']);
                                        $loyaltypoint = htmlspecialchars($row['loyaltypoint']);
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $loyaltypoint; ?></td>
                                            <td><?php echo $date; ?></td>
        
                                            <td><a href="../api/customers/process.viewordercustomer.php?customerid=<?php echo $customerid; ?>" class="btn btn-success edit-button">Edit</a></td>
                                            <td> <a href="../api/customers/process.deleteordercustomer.php?customerid=<?php echo $customerid; ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                <?php
                                    }
